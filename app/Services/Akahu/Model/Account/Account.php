...
final class Account
{
    ...
    public static function fromJson(array $json): self
    {
        ...
        $account->connection       = array_key_exists('connection', $json) ? Connection::fromJson($json['connection']) : null;
        ...
        $account->refreshed        = array_key_exists('refreshed', $json) ? Refreshed::fromJson($json['refreshed']) : null;

        $account->balance          = array_key_exists('balance', $json) ? Balance::fromJson($json['balance']) : null;
    ...
    public static function fromArray(array $data): self
    {
        ...
        $account->connection       = array_key_exists('connection', $data) ? Connection::fromArray($data['connection']) : null;
        ...
        $account->refreshed        = array_key_exists('refreshed', $data) ? Refreshed::fromArray($data['refreshed']) : null;

        $account->balance          = array_key_exists('balance', $data) ? Balance::fromArray($data['balance']) : null;
