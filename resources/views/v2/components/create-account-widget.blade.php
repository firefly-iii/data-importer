                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center flex-grow-1">
                            ...
                            <input type="text"
                                   ...
                                   name="new_accounts[{{ $account['import_account']->id }}][name]"
                ...
                <div class="col-12">
                    <div class="d-flex align-items-center">
                        ...
                        <select class="form-control"
                                ...
                                name="new_accounts[{{  $account['import_account']->id }}][type]"
                ...
                <div class="col-12">
                    <div class="d-flex align-items-center">
                        ...
                        <select class="form-control"
                                ...
                                name="new_accounts[{{  $account['import_account']->id }}][account_role]">
                            @php
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center">
                            ...
                            <select class="form-control"
                                    ...
                                    name="new_accounts[{{ $account['import_account']->id }}][liability_type]">
                                @php
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="btn-group" role="group" data-bs-toggle="buttons">
                                <input type="radio" class="btn-check"
                                       name="new_accounts[{{  $account['import_account']->id }}][liability_direction]"
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="me-3 flex-grow-1">
                            ...
                            <input type="number"
                                   ...
                                   name="new_accounts[{{ $account['import_account']->id }}][opening_balance]"
