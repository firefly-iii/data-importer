...
@section('content')
    ...
    @if('simplefin' === $flow && count($newAccountsToCreate) > 0)
    <div class="row mt-3">
        <div class="col-lg-10 offset-lg-1">
            <div class="card border-warning">
                ...
                <div class="card-body">
                    <p class="text-muted">
                        The following accounts will be created in Firefly III before importing transactions. You can customize their settings below or proceed with the default values.
                    </p>
                                    ...
                                    <div class="col-md-6">
                                        <form class="new-account-form" data-account-id="{{ $simplefinAccountId }}">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="account_name" value="{{ $accountData['name'] ?? '' }}" required>
                                            </div>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <small class="form-text text-muted">Smart default: asset account (recommended for most accounts)</small>
                                            </div>

                                            <div class="form-group mb-2">
                                                <label class="form-label">Currency:</label>
                                                <input type="text" class="form-control form-control-sm" name="account_currency" value="{{ $accountData['currency'] ?? 'EUR' }}" maxlength="12" required>
                                                <small class="form-text text-muted">3-letter currency code</small>
                                            </div>

                                            <div class="form-group mb-2">
                                                <label class="form-label">Opening balance (optional):</label>
                                                <input type="number" step="0.01" class="form-control form-control-sm" name="opening_balance" placeholder="0.00">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                    ...
                    <div class="alert alert-info">
                        <small>
                            ...
                            These accounts will be created automatically when you start the conversion process. You can modify the details above or proceed with the defaults.
                        </small>
                    </div>
                </div>
            </div>
